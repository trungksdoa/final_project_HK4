                                                ...
                                                <form name="myform" action="/salescouponcontent/create" method="POST" onsubmit="return validation()">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-1 ">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input hidden="true"  name="check" value="${check}" >
                                                                </div>
                                                                <!-- /.input group -->
                                                            </div>
                                                            <div  class="col-2 ">
                                                                ...
                                                                <div  class="input-group">
                                                                    <input type="text" name="salescouponId" id="salescouponId" value="${salesCoupon.getQuotesId()}" class="form-control" placeholder="Enter quotes">
                                                                    <input hidden="true" type="text" name="asalescouponId" id="asalescouponId" value="${salesCoupon.getQuotesId()}" class="form-control" placeholder="Enter quotes">
                                                                </div>
                                                                <!-- /.input group -->
                                                            </div>
                                                            <div class="col-1">
                                                                <label>Code</label>
                                                                <input readonly  type="text" name="id" class="form-control" value="${salesCoupon.getId()}" placeholder="Auto">
                                                            </div>
                                                            <div class="col-2">
                                                                <label>Date</label>
                                                                <input name="date" id="date" type="date" class="form-control " value="${salesCoupon.getDate()}" placeholder="Auto">
                                                            </div>
                                                            <!-- Date and time -->
                                                            <div class="col-3">
                                                                <label>Customer / Company </label>
                                                                <div class="input-group date"  id="reservationdatetime" data-target-input="nearest">
                                                                    <input style="background-color:#FFFAE3" type="text" value="${customer.getName()}" name="customername" id="customername" onkeyup="checkkeyup()" class="form-control datetimepicker-input"
                                                                           placeholder="Nhập khách hàng/ Công ty" data-target="#reservationdatetime">
                                                                    <input hidden="true"  type="text" value="${customer.getName()}"  id="acustomername"  class="form-control datetimepicker-input"
                                                                           placeholder="Nhập khách hàng/ Công ty" data-target="#reservationdatetime">
                                                                    <input hidden="true" text="text" value="${customer.getId()}" name="customerId" id="customerId"/> 
                                                                    <input hidden="true" text="text" value="${customer.getName()}" name="namecs" value="" id="namecs"/> 
                                                            ...
                                                            <div class="col-2">
                                                                ...
                                                                <div style="width: 150px" class="input-group">
                                                                    <input readonly type="text" name="phone" id="phone" value="${salesCoupon.getPhone()}" class="form-control" placeholder="Fill phone number">
                                                                </div>
                                                                <!-- /.input group -->
                                                            </div>
                                                            <!--                                                            <div class="col-1 "></div>-->
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-2 ">
                                                                <label>Address</label>
                                                                <input readonly type="text" value="${salesCoupon.getAddress()}" name="address" id="address" class="form-control" placeholder="Fill address">
                                                                <!-- /.input group -->
                                                            </div>
                                                            <div class="col-2">
                                                                <label>Receiver</label>
                                                                <input type="text" value="${salesCoupon.getReceiver()}" name="receiver" id="receiver" class="form-control" placeholder="Enter recever">
                                                                <!-- /.input group -->
                                                            </div>
                                                            <div class="col-2">
                                                                <label>Seller</label>
                                                                <input type="text" name="creator" value="${salesCoupon.getSeller()}" id="creator"  id="receiver" class="form-control" placeholder="Enter seller">
                                                                <input hidden="true" text="text" name="checkcrt" value="" id="checkcrt"/> 
                                                            </div>

                                                            <div class="col-3">
                                                                <label>Explain</label>
                                                                <input type="text" name="explain" value="${salesCoupon.getExpain()}" id="explain" class="form-control" placeholder="Explain contnet">
                                                                <!-- /.input group -->
                                                            </div>
