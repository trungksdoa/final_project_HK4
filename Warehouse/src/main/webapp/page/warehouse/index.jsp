                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${list}" var="x">
                                <tr>
                                    <td>
                                        <p id="text1"><c:out value="${x.getId()}"></c:out></p>
                                        <input style="display: none;" id="input1" type="text" value="<c:out value="${x.getId()}"></c:out>" />
                                        </td>
                                        <td>
                                            <p id="text2">${x.getDate()}</p>
                                        <input style="display: none;" id="input2" type="text" value="<c:out value="${x.getDate()}"></c:out>" />
                                        </td>
                                    </tr>
                            </c:forEach>
