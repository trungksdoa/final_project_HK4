            ...
            function autocomplete(inp, arr) {
                ...
                inp.addEventListener("input", function (e) {
                    ...
                    for (i = 0; i < arr.length; i++) {
                        ...
                        if (arr[i]['ma'].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
                            /*create a DIV element for each matching element:*/
                            b = document.createElement("DIV");
                            /*make the matching letters bold:*/
//                            b.innerHTML = "<strong>" + arr[i]['ma'].substr(0, val.length) +  "</strong>";
                            b.innerHTML = "<strong>" + arr[i]['ma'] + "-" + arr[i]['ten'] + "</strong>";
                            b.innerHTML += arr[i]['ma'].substr(val.length);
                            /*insert a input field that will hold the current array item's value:*/
                            b.innerHTML += "<input type='hidden' value='" + arr[i]['ten'] + "'>";
            ...
            $(document).ready(function () {
                ...
                $("#txtNhaCungCap").keyup(function () {
                    var search = $(this).val();

                    if (search != "") {

                        $.ajax({
                            url: 'FindBylNhacungcap',
                            type: 'post',
                            data: {id: search},
                            dataType: 'json',
                            success: function (response) {
                                ...
                                $("#txtNhaCungCap").empty();
                                for (var i = 0; i < len; i++) {
                                    var id = response[i]['ma'];
                                    var name = response[i]['ten'];
                                    console.log(id + name)

//                                    $("#searchResult").append("<li value='" + id + "'>" + "Mã: " + id + " -" + "Tên: " + name + "</li>");
//                                    setText(this);
                                }
                                console.log(response)
                                autocomplete(document.getElementById("txtNhaCungCap"), response);
